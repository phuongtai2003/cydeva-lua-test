...
class _AuthDataSource implements AuthDataSource {
  ...
  Future<GeneralResponse<LoginResponseData>> login(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GeneralResponse<LoginResponseData>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GeneralResponse<LoginResponseData>.fromJson(
      _result.data!,
  ...
  @override
  Future<GeneralResponse<UserData>> getUserData() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
